package com.prakpbp.aplikasifirebase;
...
public class ListMhsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://praktikum-firebase-39740-default-rtdb.firebaseio.com/").getReference("mhs");
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                myAdapter.setOnItemClickListener(position -> {
                    ...
                    startActivity(new
                            Intent(ListMhsActivity.this, EditMhsActivity.class).putExtra("nim", nim)
                    );
                });
            }
